...
// These constants are an important variables.
// All KVStore plugins MUST use the same value in their plugin.ServeConfig when
// specifying the type of plugin they are (pluginMap).
// Their names can be any string value you wish, as long as they are unique
// for each type of plugin.
const (
	KVStoreGrpcPluginName   = "kv_grpc"
	KVStoreNetRpcPluginName = "kv_netrpc"
)
